  ...
  return (
    <div className='h-[80vh]'>
     ...
     <div className='h-[50%] p-10 mt-5 text-center text-black'>
        ...
        <p className='mt-5 mb-10 text-zinc-800'>Detaylar için mailinizi kontrol edebilirsiniz</p>

        <Link href="/orders" className='border shadow py-2 px-5 rounded-lg 
        text-lg hover:shadow-lg gover:bg-gray-100'>Siparişlerim</Link>

      <br/>
      <br/>

      <Link href="/" className='border shadow py-2 px-5 rounded-lg 
        text-lg hover:shadow-lg hover:bg-gray-100'>Anasayfa</Link>
