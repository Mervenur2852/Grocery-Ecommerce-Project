    ...
    bg-gradient-to-r from-green-600 to-green-700'>
      ...
      <p className='my-3'>
       En taze meyve ve sebzeler elinizin altında. Sağlıklı yaşamın ilk adımı
          ...
          <button className='bg-white inline-block w-fit text-green-700
          py-2 px-4 rounded-md hover:bg-green-50 transition cursor-pointer'>
            Alışverişe Başla</button>
      
    </div>

        <div className='max-lg:hidden flex flex-col justify-between p-6 rounded-lg 
