...
import CartAction from './card-action';
...
const Card : FC <Props> = ({product}) => {
  return (
    <div className='border border-gray-200 rounded-lg shadow-sm hover:shadow-md transition 
    overflow-hidden bg-white '>
        ...
        <div className="flex justify-between items-start mb-2">
          <div>
            ...
            <span className="tedxt-sm text-gray-600">{product.origin}</span>
          </div>
        ...
        <div className="flex justify-between items-center mt-2">
         ...
         <CartAction productId ={product._id} />
        </div>
      </div>
    </div>
  );
